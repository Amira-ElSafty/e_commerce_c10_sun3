...
class ProductListTabViewModel extends Cubit<ProductListStates>{
  ...
  ProductListTabViewModel({required this.productsUseCase,
  required this.addCartUseCase}):super(ProductListInitialState());
  ...
  void getAllProducts()async{
    ...
    either.fold((l) => emit(ProductListErrorState(errors: l)),
            (response) {
